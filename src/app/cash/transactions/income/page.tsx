      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="p-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <Typography variant="small" color="muted">New Income</Typography>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="description"
              name="description"
              placeholder="Enter transaction description like for Medicine"
          ...
          <div className="flex justify-end space-x-4">
            ...
            >
              ...
              <span>{loading ? 'Recording...' : 'Record Income'}</span>
            </Button>
          </div>
        </form>
      </Card>
